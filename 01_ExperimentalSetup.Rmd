...
Env.pca.plot<-fviz_pca_biplot(Env.pca, repel=TRUE, geom = "point", col.var="black", labelsize=sig.sz)+
  geom_point(aes(colour=EnvData.clean$Site, shape=EnvData.clean$Season, size=EnvData.clean$Season))+
  ...
  annotate("text", x=0.25, y=-2.75,label = "Site PERMANOVA p=0.015", 
           size=sig.sz-1, fontface="bold.italic", hjust=0)+
  annotate("text", x=0.25, y=-3.25,label = "Site PERMDISP p=0.507", 
