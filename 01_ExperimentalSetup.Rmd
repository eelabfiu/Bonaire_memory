...
### Load Packages
```{r}
#setwd("C:/Users/snhac/OneDrive/Documents/FIU/Bonaire Project/Year 2/Data Analysis/Bonaire Memory")
...
Study_Sites.plot<-ggplot(Bonaire.sf)+
  ...
  annotate("text", x=Sites$Long[which(Sites$Site=="SS")], y=Sites$Lat[which(Sites$Site=="SS")]+0.01, label = Sites$SiteName[which(Sites$Site=="SS")], size=sig.sz, fontface="bold", hjust=0)+
  annotate("text", x=Sites$Long[which(Sites$Site=="KL")], y=Sites$Lat[which(Sites$Site=="KL")]+0.01, label = Sites$SiteName[which(Sites$Site=="KL")], size=sig.sz, fontface="bold", hjust=1)+
  annotate("text", x=Sites$Long[which(Sites$Site=="KR")]+0.01, y=Sites$Lat[which(Sites$Site=="KR")], label = Sites$SiteName[which(Sites$Site=="KR")], size=sig.sz, fontface="bold", hjust=0)+
   annotate("text", x=Sites$Long[which(Sites$Genotype=="AC8")], y=Sites$Lat[which(Sites$Genotype=="AC8")]+0.01, label = Sites$Genotype[which(Sites$Genotype=="AC8")], size=sig.sz, fontface="bold")+
  annotate("text", x=Sites$Long[which(Sites$Genotype=="AC10")], y=Sites$Lat[which(Sites$Genotype=="AC10")]-0.01, label = Sites$Genotype[which(Sites$Genotype=="AC10")], size=sig.sz, fontface="bold")+
  annotate("text", x=Sites$Long[which(Sites$Genotype=="AC12")], y=Sites$Lat[which(Sites$Genotype=="AC12")]+0.01, label = Sites$Genotype[which(Sites$Genotype=="AC12")], size=sig.sz, fontface="bold"); Study_Sites.plot

##Save Figure
ggsave(filename="Figures/01_Design/Study_Sites.png", plot=Study_Sites.plot, dpi=300, width=6, height=8, units="in")
...
Temp.plot<-ggplot()+
  ...
  theme(axis.title.x = element_text(size = axis.title.sz), axis.title.y = element_text(size = axis.title.sz), 
        axis.text.x=element_text(size=axis.txt.sz, colour="black"), axis.text.y=element_text(size=axis.txt.sz, colour="black"), 
        legend.text=element_text(size=leg.txt.sz), legend.title=element_text(size=leg.title.sz), legend.box.background = element_rect(color = "black"),  legend.direction = "horizontal", legend.position=c(0.5,0.9))+
  scale_color_manual(values = c(Site.colors.o))+
    labs(x="Date", y="Temperature (\u00B0C)");Temp.plot

##Save Figure
ggsave(filename="Figures/01_Design/Temperature.png", plot=Temp.plot, dpi=300, width=12, height=4, units="in")
...
```{r}
Cond.plot<-ggplot()+
  geom_line(data=na.omit(TempCond), aes(color=Site, x=Date.Time, y=Cond_mS.cm), linewidth=bar.sz-.25, alpha=0.7) +  
  theme_bw()+
  theme(axis.title.x = element_text(size = axis.title.sz), axis.title.y = element_text(size = axis.title.sz), 
        axis.text.x=element_text(size=axis.txt.sz, colour="black"), axis.text.y=element_text(size=axis.txt.sz, colour="black"), 
        legend.text=element_text(size=leg.txt.sz), legend.title=element_text(size=leg.title.sz), legend.box.background = element_rect(color = "black"),  legend.direction = "horizontal", legend.position=c(0.5,0.1))+
  scale_color_manual(values = c(Site.colors.o))+
    labs(x="Date", y="Conductivity (\u03BCS/cm)");Cond.plot

##Save Figure
ggsave(filename="Figures/01_Design/Conductivity.png", plot=Cond.plot, dpi=300, width=12, height=4, units="in")
...
Light.plot<-ggplot()+
  ...
  theme_bw()+
  theme(axis.title.x = element_text(size = axis.title.sz), axis.title.y = element_markdown(size = axis.title.sz), 
        axis.text.x=element_text(size=axis.txt.sz, colour="black"), axis.text.y=element_text(size=axis.txt.sz, colour="black"), 
        legend.text=element_text(size=leg.txt.sz), legend.title=element_text(size=leg.title.sz), legend.box.background = element_rect(color = "black"),  legend.direction = "horizontal", legend.position=c(0.5,0.9))+
  scale_color_manual(values = c(Site.colors.o))+
    labs(x="Date", y="PAR (\u03BCmol/m^2/s)");Light.plot


##Save Figure
ggsave(filename="Figures/01_Design/Light.png", plot=Light.plot, dpi=300, width=12, height=4, units="in")
...
##Save Figure
ggsave(filename="Figures/01_Design/NtoP.png", plot=N.P.plot, dpi=300, width=12, height=4, units="in")
...
##Save Figure
ggsave(filename="Figures/01_Design/DIN.png", plot=DIN.plot, dpi=300, width=12, height=4, units="in")
...
Keep main parameters of interest Temp.a, Temp.sd, Cond.a, Cond.sd, PAR.a, DIN, N.P
```{r}
names(EnvData)
...
```{r}
names(EnvData.cut)
adonis2(vegdist(EnvData.cut[,3:9], "euclidean")~EnvData.cut$Site, data=EnvData.cut, method="euclidean")

##Check dispersion by Site
anova(betadisper(vegdist(EnvData.cut[,3:9], "euclidean"), EnvData.cut$Site))
...
##PCA
Env.pca<-prcomp(EnvData.cut[,-c(1:2)], scale.=TRUE)

summary(Env.pca)

Env.pca.plot<-autoplot(Env.pca, data=EnvData.cut, colour="Site", loadings=TRUE,
         loadings.label=TRUE, loadings.colour="black", loadings.label.colour="black", size=point.sz)+
    scale_colour_manual(values =Site.colors.o)+
  theme_classic()+
   theme(axis.title.x = element_text(size = axis.title.sz), axis.title.y = element_text(size = axis.title.sz), 
        axis.text.x=element_text(size=axis.txt.sz, colour="black"), axis.text.y=element_text(size=axis.txt.sz, colour="black"), 
        legend.text=element_text(size=leg.title.sz), legend.title=element_text(size=leg.title.sz), 
        legend.box.background = element_rect(color = "black"))+
  annotate("text", x=0.01, y=-0.32,label = "Site PERMANOVA p=0.017", size=sig.sz-1, fontface="bold.italic", hjust=0)+
  annotate("text", x=0.01, y=-0.35,label = "Site PERMDISP p=0.507", size=sig.sz-1, fontface="italic", hjust=0); Env.pca.plot

##Save figure
ggsave(filename="Figures/01_Design/Environment.png", plot=Env.pca.plot, dpi=300, width=8, height=6, units="in")
...
```{r}
##PC1
fviz_contrib(Env.pca, choice = "var", axes = 1, top = 10)

##PC2
fviz_contrib(Env.pca, choice = "var", axes = 2, top = 10)

##PC1 and 2
fviz_contrib(Env.pca, choice = "var", axes = 1:2, top = 10)
...
HA_Design.plot<-ggplot(data=HA_Design, aes(color=TempTreatment, x=Hours, y=Temp_C)) +
  annotate("rect", xmin=6, xmax=7, ymin=-Inf, ymax=Inf, alpha=0.8, fill="grey80")+
  annotate("rect", xmin=8, xmax=9, ymin=-Inf, ymax=Inf, alpha=0.8, fill="grey80")+
  annotate("rect", xmin=10, xmax=11, ymin=-Inf, ymax=Inf, alpha=0.8, fill="grey80")+
  ...
  theme(axis.title.x = element_text(size = axis.title.sz), axis.title.y = element_text(size = axis.title.sz), 
        axis.text.x=element_text(size=axis.txt.sz, colour="black"), axis.text.y=element_text(size=axis.txt.sz, colour="black"), 
         legend.text=element_text(size=leg.txt.sz), legend.title=element_text(size=leg.title.sz), legend.box.background = element_rect(color = "black"),  legend.direction = "vertical", legend.position=c(0.8,0.8))+
...
##Save figure
ggsave(filename="Figures/01_Design/HeatAssayDesign.png", plot=HA_Design.plot, dpi=300, width=8, height=4, units="in")
...
HCTemp.plot<-ggplot() +
  ...
  theme(axis.title.x = element_text(size = axis.title.sz), axis.title.y = element_text(size = axis.title.sz), 
        axis.text.x=element_text(size=axis.txt.sz, colour="black"), axis.text.y=element_text(size=axis.txt.sz, colour="black"), 
        legend.position="none", strip.text.y.right=element_text(size=axis.txt.sz, colour="black", angle = 0))+
...
##Save figure
ggsave(filename="Figures/01_Design/HeatAssayTemp.png", plot=HCTemp.plot, dpi=300, width=4, height=8, units="in")
...
##Save Figure
ggsave(filename="Figures/01_Design/Fig1BC_Study_Design.png", plot=Study.Design_fig, dpi=300, width=6, height=8, units="in")
...
```{r}
Temp.plot.cut<-ggplot()+
  geom_line(data=na.omit(TempCond), aes(color=Site, x=Date.Time, y=Temp_C), linewidth=bar.sz-.25, alpha=0.7) +  
  theme_bw()+
  theme(axis.title.x = element_blank(), axis.title.y = element_text(size = axis.txt.sz), 
        axis.text.x=element_text(size=axis.txt.sz, colour="black"), axis.text.y=element_text(size=axis.txt.sz, colour="black"), 
        legend.text=element_text(size=leg.txt.sz), legend.title=element_text(size=leg.title.sz), legend.box.background = element_rect(color = "black"),  legend.direction = "horizontal", legend.position=c(0.5,0.8))+
  scale_color_manual(values = c(Site.colors.o))+
    labs(x=NULL, y="Temperature (\u00B0C)")

Cond.plot.cut<-ggplot()+
  geom_line(data=na.omit(TempCond), aes(color=Site, x=Date.Time, y=Cond_mS.cm), linewidth=bar.sz-.25, alpha=0.7) +  
  theme_bw()+
  theme(axis.title.x = element_blank(), axis.title.y = element_text(size = axis.txt.sz), 
        axis.text.x=element_text(size=axis.txt.sz, colour="black"), axis.text.y=element_text(size=axis.txt.sz, colour="black"), 
        legend.position="none")+
  scale_color_manual(values = c(Site.colors.o))+
    labs(x=NULL, y="Conductivity (\u03BCS/cm)")

Light.plot.cut<-ggplot()+
  geom_line(data=na.omit(PAR), aes(color=Site, x=Date.Time, y=PAR_umol.m2.s), linewidth=bar.sz-.25, alpha=0.7) +  
  theme_bw()+
  theme(axis.title.x = element_blank(), axis.title.y = element_text(size = axis.txt.sz), 
        axis.text.x=element_text(size=axis.txt.sz, colour="black"), axis.text.y=element_text(size=axis.txt.sz, colour="black"), 
        legend.position="none")+
  scale_color_manual(values = c(Site.colors.o))+
    labs(x=NULL, y="PAR (\u03BCmol/m^2/s)")

N.P.plot.cut<-ggplot()+
  geom_line(data=na.omit(Nutrients.o), aes(color=Site, x=Date, y=N.P), linewidth=bar.sz) +  
  geom_point(data=na.omit(Nutrients.o), aes(color=Site, x=Date, y=N.P), size=point.sz-1) +  
  theme_bw()+
  theme(axis.title.x = element_blank(), axis.title.y = element_text(size = axis.txt.sz),
        axis.text.x=element_text(size=axis.txt.sz, colour="black"), axis.text.y=element_text(size=axis.txt.sz, colour="black"), 
        legend.position="none")+
  scale_color_manual(values = c(Site.colors.o))+
    labs(x=NULL, y="Total N:P")

DIN.plot.cut<-ggplot()+
  geom_line(data=na.omit(Nutrients.o), aes(color=Site, x=Date, y=DIN_uM), linewidth=bar.sz) +  
  geom_point(data=na.omit(Nutrients.o), aes(color=Site, x=Date, y=DIN_uM), size=point.sz-1) +  
  theme_bw()+
  theme(axis.title.x = element_text(size = axis.title.sz), axis.title.y = element_text(size = axis.txt.sz), 
        axis.text.x=element_text(size=axis.txt.sz, colour="black"), axis.text.y=element_text(size=axis.txt.sz, colour="black"), 
        legend.position="none")+
  scale_color_manual(values = c(Site.colors.o))+
    labs(x="Date", y="DIN (\u03BCM)")
```
...
```{r}
##Create Panel
Env.Param_fig<-plot_grid(Temp.plot.cut, Cond.plot.cut, Light.plot.cut, N.P.plot.cut, DIN.plot.cut,
                        rel_widths=c(1, 1, 1, 1, 1, 1), rel_heights=c(1, 1, 1, 1, 1), 
                        nrow=5, byrow=T, labels = c('A', 'B', 'C', 'D', 'E'), 
                        label_size=panel.lab.sz)

##Save Figure
ggsave(filename="Figures/01_Design/FigS1_Environmental_Conditions.png", plot=Env.Param_fig, dpi=300, width=8, height=12, units="in")

```


### Figure S2B
Note: Figure S2A is thermal tolerance assessment tank diagram. 
```{r}
##Save figure
ggsave(filename="Figures/01_Design/FigS2B_Heat_Assay_Temperatures.png", plot=HCTemp.plot, dpi=300, width=4, height=8, units="in")
```
