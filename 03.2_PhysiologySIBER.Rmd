...
corrplot(Phys.corr$r, type="upper", order="hclust", 
         p.mat = Phys.corr$P, sig.level = 0.01, insig = "blank", tl.col="black")
...
phys.nmds.plot<-ggplot(data = phys.nmds.samples.plot.data, aes(x = MDS1, y = MDS2)) + 
  ...
  annotate("text", x = -1.1, y = -1.2, label = NMDS.stress, hjust=0, size=sig.sz); phys.nmds.plot
```
...
##Save Figure
ggsave(filename="Figures/02_Physiology/Fig3_AverageNicheOverlap.png", plot=NicheOverlap_fig, dpi=300, width=14, height=9, units="in")
...
##Save Figure
ggsave(filename="Figures/02_Physiology/FigS3_PhysiologicalNiche.png", plot=PhysNiche_fig, dpi=300, width=12, height=6, units="in")
...
ellipse.plot_SS<-ellipse.plot_KL + ggtitle("Something Special") + 
  theme(plot.title = element_text(colour="black", size=panel.lab.sz, face="bold", hjust=0.5))
...
##Save Figure
ggsave(filename="Figures/02_Physiology/FigS4_PhysiologicalNicheEllipse.png", plot=Ellipse_fig, dpi=300, width=8, height=14, units="in")
