...
CoralData<-merge(Corals_Main[,c(1:5, 8:9, 13:14, 16)], Prot.C.a, all.x=TRUE)
...
#Retains all Main samples
names(Bio.C.o)
CoralData<-merge(CoralData, Bio.C.o[,c(1, 26)], all.x=TRUE)
names(Bio.S.o)
CoralData<-merge(CoralData, Bio.S.o[,c(1, 26)], all.x=TRUE)
